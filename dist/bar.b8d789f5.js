...
Promise.all([d3.csv(require('../data/bar_rejected.csv'))]).then(ready).catch(function (err) {
...
function ready(_ref) {
  ...
  var dateScale = d3.scaleTime().domain([new Date('2010-10-01'), new Date('2014-04-01')]).range([0, width]);
...
},{}]},{},["../node_modules/parcel/src/builtins/hmr-runtime.js","bar.js"], null)
//# sourceMappingURL=/bar.b8d789f5.map